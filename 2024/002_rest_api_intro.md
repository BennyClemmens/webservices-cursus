...
- [hogent](TODO)
- [panopto](TODO)
- `D:/DATA/Videos/WEBSERVICES/H002_TODO.mp4`
...
<p align="center">
  <img src="img/rest_resources.png" style="width:50%;" alt="rest_resources">
</p>
<!-- markdownlint-enable -->
...
Laten we een POST request uitvoeren in Postman. Kies de juiste method en typ de URL in het veld. We gebruiken hier een publieke API om afbeeldingen te generen: <https://kroki.io/plantuml/png>.

Vervolgens moeten we nog onze data in de body doorsturen. Kies in bij het tabblad `Body` voor `raw` en wijzig `JSON` naar `text`.

<!-- markdownlint-disable -->
<p align="center">
  <img src="img/postman1.png" style="width:50%;" alt="postman1">
</p>
<!-- markdownlint-enable -->
...
<!-- markdownlint-disable -->
<p align="center">
  <img src="img/postman2.png" style="width:50%;" alt="postman2">
</p>
<!-- markdownlint-enable -->
...
<!-- markdownlint-disable -->
<p align="center">
  <img src="img/kroki_erd.svg" style="width:50%;" alt="kroki_erd">
</p>
<!-- markdownlint-enable -->
...
Sommige API's zijn door iedereen vrij te gebruiken, zoals de FBI most wanted, maar heel vaak is dat niet zo. Er zijn in essentie twee redenen om een API call af te schermen
...
<!-- markdownlint-disable -->
<p align="center">
  <img src="img/fout_erd.svg" style="width:50%;" alt="fout_erd">
</p>
<!-- markdownlint-enable -->
...
<!-- markdownlint-disable -->
<p align="center">
  <img src="img/goed_erd.svg" style="width:50%;" alt="goed_erd">
</p>
<!-- markdownlint-enable -->
...
Voor het bouwen van web API's wordt er meestal een framework gebruikt en geen 'naakte' Node.js. Express is waarschijnlijk de meest gekende en meest gebruikte, maar krijgt nog weinig tot geen updates. Wij gebruiken in deze cursus Koa, het nieuwe hippe framework van hetzelfde team achter Express.
...
<!-- markdownlint-disable -->
<p align="center">
  <img src="img/middle.png" style="width:50%;" alt="middle">
</p>
<!-- markdownlint-enable -->
...
- eens vóór de aanroep van `next()`
- én eens ná de aanroep van `next()`

Dit is wat men het onion model noemt:

<!-- markdownlint-disable -->
<p align="center">
  <img src="img/onion.png" style="width:50%;" alt="onion">
</p>
<!-- markdownlint-enable -->
...
<!-- markdownlint-disable -->
<p align="center">
  <img src="img/debugging-in-vscode.png" style="width:50%;" alt="debugging-in-vscode">
</p>
<!-- markdownlint-enable -->
...
<!-- markdownlint-disable -->
<p align="center">
  <img src="img/debugger-attached.png" style="width:50%;" alt="debugger-attached">
</p>
<!-- markdownlint-enable -->
...
<!-- markdownlint-disable -->
<p align="center">
  <img src="img/breakpoint.png" style="width:50%;" alt="breakpoint">
</p>
<!-- markdownlint-enable -->
...
Maak een `eslint.config.mjs` bestand in de root met onderstaande configuratie. De extensie `mjs` staat voor ES modules en laat ons toe om ES modules te gebruiken in Node.js. Je kan de configuratie ook in TypeScript schrijven, maar dat vereist extra stappen die een beetje overkill zijn.
...
Indien je een foutmelding krijgt dat `typescript-eslint` jouw versie van TypeScript niet ondersteunt: pas de versie van TypeScript in `package.json` aan naar een ondersteunde versie. Soms helpt het ook om de `^` te vervangen door een `~` voor de versie van `typescript` in de `package.json`.
