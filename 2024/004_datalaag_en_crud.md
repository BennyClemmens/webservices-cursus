...
- [hogent](TODO)
- [panopto](TODO)
- `D:/DATA/Videos/WEBSERVICES/H004_TODO.mp4`
...
> Let op: Het .env bestand mag nooit op GitHub komen! Als je de `.gitignore` uit hoofdstuk 2 correct hebt ingesteld, zal dit bestand niet op GitHub komen.
...
<p align="center">
  <img src="img/versioncontrol-xkcd.jpg" style="width:50%;" alt="versioncontrol-xkcd">
</p>
<!-- markdownlint-enable -->
...
> ocht je in productie toch data willen toevoegen, zoals bv. een aantal categorieën van producten in een webshop, dan maak je hiervoor een migratie en geen seed.
...
Vergeet geen `.env` aan te maken! Bekijk de `README` voor meer informatie.
