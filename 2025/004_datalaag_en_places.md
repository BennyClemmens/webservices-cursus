# [^](../README.md) Datalaag en places

## Lesopname

- [hogent](TODO)
- [panopto](TODO)
- `D:/DATA/Videos/WEBSERVICES/2025/H004_TODO.mp4`
...
#### Zelf queries schrijven samengevat
...
- (1) Je installeert MySQL zoals in de [instructies aan het begin van de cursus](https://hogent-frontendweb.github.io/webservices-cursus/#/../0-intro/software?id=mysql)
...
<p align="center">
  <img src="img/04_budget_erd.svg" style="width:50%;" alt="04_budget_erd">
</p>
<!-- markdownlint-enable -->
...
<!-- markdownlint-disable -->
<p align="center">
  <img src="img/04_versioncontrol-xkcd.jpg" style="width:50%;" alt="04_versioncontrol-xkcd">
</p>
<!-- markdownlint-enable -->
...
Open dus MySQL Workbench en controleer of de `budget` databank bestaat. Mocht je gebruik maken van [Docker Compose](https://hogent-frontendweb.github.io/webservices-cursus/#/4-datalaag/deel1?id=mysql-in-docker), dan bestaat deze databank reeds. Als je geen Docker gebruikt, moet je een nieuwe databank aanmaken. Uiteraard pas je de naam van de databank aan naar de naam die je gekozen hebt in de `DATABASE_URL` variabele in `.env`.
...
> **Tip**: documenteer duidelijk in de `README.md` hoe je de server start en welke stappen je moet ondernemen om de databank correct te initialiseren. *Dit is ook één van de ontvankelijkheidscriteria voor de examenopdracht (en wordt vaak verwaarloosd)*.
...
<!-- markdownlint-disable -->
<p align="center">
  <img src="img/04_lagen.png" alt="04_lagen">
</p>
<!-- markdownlint-enable -->
