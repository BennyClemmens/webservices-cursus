...
- [hogent](https://chamilo.hogent.be/index.php?go=CourseViewer&application=Chamilo%5CApplication%5CWeblcms&course=69695&tool=LectureCapture&browser=Hogent%5CApplication%5CWeblcms%5CTool%5CImplementation%5CLectureCapture%5CRenderer%5CVideoPublicationListRenderer&tool_action=viewer&publication=2590370)
- [panopto](https://hogent.cloud.panopto.eu/Panopto/Pages/Viewer.aspx?id=dacfc09a-a1bb-4e4e-9b10-b36700ce618d&start=0)
- `D:/DATA/Videos/WEBSERVICES/2025/H002.mp4`
...
<p align="center">
  <img src="img/02_rest_resources.png" style="width:50%;" alt="rest_resources">
</p>
<!-- markdownlint-enable -->
...
| **406**  | Not Acceptable         | De client heeft een accept header gestuurd die niet ondersteund wordt (bv. XML gevraagd terwijl de server enkel JSON kan retourneren). |
...
Een volledige lijst van HTTP status codes kan je vinden op <https://developer.mozilla.org>.
...
- `Uniforme interface`: een request identificeert een `resource`, door gebruik te maken van `URI's`. Er zijn vier architecturale beperkingen nodig om het gedrag van componenten vast te leggen:
...
- `Client/server-architectuur`: de clients van de API gebruiken HTTP calls om een resource te vragen (een GET-methode) of data naar de server te sturen (een PUT, POST of DELETE-methode). De client moet voldoende hebben aan de verschillende URI's voor alle resources. De documentatie van de API bevat de beschikbare URI's/methoden die door de API worden ondersteund. De client en de server moeten onafhankelijk van elkaar kunnen evolueren. Door de gebruikersinterface te scheiden van de opslag, kan een gebruikersinterface voor meerdere platformen gebouwd worden.

- `Stateless`: een stateless applicatie houdt geen verbinding in stand en slaat geen informatie op tussen requests van dezelfde client. Een client doet een request, de API voert de actie uit die in het request is gedefinieerd en reageert. Zodra de API reageert, verbreekt hij de verbinding en bewaart hij geen informatie over de client in het actieve geheugen. De API behandelt elke request als een eerste request. Dit betekent dat ieder request van client naar server alle nodige informatie moet bevatten om het verzoek te begrijpen en kan geen gebruik maken van enige opgeslagen context op de server. De sessie-status wordt volledig op de client opgeslagen.
...
Een vaak gebruikt programma hiervoor is [Postman](https://www.postman.com/). postman heft ook [een extensie voor VSZ Code](https://marketplace.visualstudio.com/items?itemName=Postman.postman-for-vscode). Er zijn natuurlijk nog alternatieven zoals bv. [Insomnia](https://insomnia.rest/), [Bruno](https://www.usebruno.com/) (ziet er veelbelovend uit) of [Thunder Client](https://marketplace.visualstudio.com/items?itemName=rangav.vscode-thunder-client) (een extensie voor VSCode). Als je de [nodige software](https://hogent-frontendweb.github.io/webservices-cursus/#/../0-intro/software) reeds geïnstalleerd hebt, dan heb je Postman reeds op je systeem staan.
...
- (2) Typ de URL in het veld. We gebruiken hier een publieke API om afbeeldingen te generen: <https://kroki.io/plantuml/png> (niet klikken, enkel kopiëren 🙃︎)..
...
<!-- markdownlint-disable -->
<p align="center">
  <img src="img/02_postman1.png" style="width:50%;" alt="postman1">
</p>
<!-- markdownlint-enable -->
...
<!-- markdownlint-disable -->
<p align="center">
  <img src="img/02_postman2.png" style="width:50%;" alt="postman2">
</p>
<!-- markdownlint-enable -->
...
Een mooi voorbeeld van publieke API's zijn de 100+ datasets die de stad Gent aanbiedt als open data, van de bezetting van de parkeergarages tot de locatie van de grazende schapen: <https://data.stad.gent/explore/>.
...
<!-- markdownlint-disable -->
<p align="center">
  <img src="img/02_kroki_erd.svg" style="width:50%;" alt="kroki_erd">
</p>
<!-- markdownlint-enable -->
...
<!-- markdownlint-disable -->
<p align="center">
  <img src="img/02_fout_erd.svg" style="width:50%;" alt="fout_erd">
</p>
<!-- markdownlint-enable -->
...
<!-- markdownlint-disable -->
<p align="center">
  <img src="img/02_goed_erd.svg" style="width:50%;" alt="goed_erd">
</p>
<!-- markdownlint-enable -->
...
De [package.json](https://docs.npmjs.com/cli/v10/configuring-npm/package-json) bevat alle metadata van ons project, meer in het bijzonder alle dependencies en commando's om onze app te starten. Open `package.json` en bekijk de inhoud. Dese bevat enkele properties:
...
- `packageManager`: de package manager die gebruikt wordt (in dit geval pnpn)
...
Met een simpele `pnpn install` installeren we meteen een identieke omgeving (met zowel `dependencies` als `devDependencies`) en dat maakt het handiger om in een team te werken (`pnpm install --prod` installeert enkel de `dependencies`).
...
<!-- markdownlint-disable -->
<p align="center">
  <img src="img/02_debugging-in-vscode.png" style="width:50%;" alt="02_debugging-in-vscode">
</p>
<!-- markdownlint-enable -->
...
<!-- markdownlint-disable -->
<p align="center">
  <img src="img/02_debugger-attached.png" style="width:50%;" alt="02_debugger-attached">
</p>
<!-- markdownlint-enable -->
...
<!-- markdownlint-disable -->
<p align="center">
  <img src="img/02_breakpoint.png" style="width:50%;" alt="02_breakpoint">
</p>
<!-- markdownlint-enable -->
...
> **Tip**: Gebruik de API calls van het [uitgewerkte voorbeeld](https://hogent-frontendweb.github.io/webservices-cursus/#/2-REST_api_intro/index?id=rest---een-uitgewerkt-voorbeeld) als referentie.
