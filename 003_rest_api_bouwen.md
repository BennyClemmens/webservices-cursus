...
- [hogent](TODO)
- [panopto](TODO)
- `D:/DATA/Videos/WEBSERVICES/H003_TODO.mp4`
...
<!-- markdownlint-disable -->
<p align="center">
  <img src="img/03_addedit.png" style="width:50%;" alt="03_addedit">
</p>
<!-- markdownlint-enable -->
...
<!-- markdownlint-disable -->
<p align="center">
  <img src="img/03_erd.png" style="width:50%;" alt="03_erd">
</p>
<!-- markdownlint-enable -->
...
Eerst installeren het `config` package en de bijhorende types. Dit package laat toe om eenvoudig configuratie te switchen op basis van de environment variabele `NODE_ENV`.
...
We definiëren een paar log configuratievariabelen zodat we iets kunnen testen. Maak hiervoor `config/development.ts` aan met volgende inhoud
...
We voegen `@koa/router koa-bodyparser`, en hun types toe om requests makkelijker af te handelen.
...
export default (app: Application) => {
  ...
  app.use(router.routes()).use(router.allowedMethods());
};KopieerOeps, er ging iets mis...Gekopieerd!
